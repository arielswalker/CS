...
{
    CS_DisableMemoryCmd_t CmdPacket;
    int32                 strCmpResult;
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.HkPacket.Payload.MemoryCSState == CS_ChecksumState_DISABLED,
...
{
    CS_EnableMemoryCmd_t CmdPacket;
    int32                strCmpResult;
    char                 ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
...
{
    CS_ReportBaselineEntryIDMemoryCmd_t CmdPacket;
    int32                               strCmpResult;
    char                                ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    CS_Res_EepromMemory_Table_Entry_t  *ResMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].ResAddr;
    ...
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].State           = CS_ChecksumState_ENABLED;
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].ComputedYet     = true;
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].ComparisonValue = 1;
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_NotYetComputed(void)
{
    ...
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].State           = CS_ChecksumState_ENABLED;
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].ComputedYet     = false;
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].ComparisonValue = 1;
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty(void)
{
    ...
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].State = CS_ChecksumState_EMPTY;
...
{
    CS_RecomputeBaselineMemoryCmd_t    CmdPacket;
    int32                              strCmpResult;
    char                               ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    CS_Res_EepromMemory_Table_Entry_t *ResMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].ResAddr;
    ...
    UtAssert_True(CS_AppData.ChildTaskTable == CS_ChecksumType_MEMORY_TABLE,
    ...
    UtAssert_True(CS_AppData.RecomputeEepromMemoryEntryPtr == &ResMemoryTblPtr[CmdPacket.Payload.EntryID],
                  "CS_AppData.RecomputeEepromMemoryEntryPtr == &ResMemoryTblPtr[CmdPacket.Payload.EntryID]");
...
{
    CS_EnableEntryIDMemoryCmd_t        CmdPacket;
    int32                              strCmpResult;
    char                               ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    CS_Def_EepromMemory_Table_Entry_t *DefMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].DefAddr;
    CS_Res_EepromMemory_Table_Entry_t *ResMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].ResAddr;
    ...
    CS_Test_Setup_SetDefEntryState(DefMemoryTblPtr[CmdPacket.Payload.EntryID].State);

    /* Execute the function being tested */
    CS_EnableEntryIDMemoryCmd(&CmdPacket);

    /* Verify results */
    UtAssert_True(ResMemoryTblPtr[CmdPacket.Payload.EntryID].State == CS_ChecksumState_ENABLED,
                  "ResMemoryTblPtr[CmdPacket.Payload.EntryID].State == CS_ChecksumState_ENABLED");
    ...
    CS_Test_Check_SetDefEntryState(&DefMemoryTblPtr[CmdPacket.Payload.EntryID], CS_ChecksumState_ENABLED);
...
void CS_EnableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty(void)
{
    ...
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].State = CS_ChecksumState_ENABLED;
    DefMemoryTblPtr[CmdPacket.Payload.EntryID].State = CS_ChecksumState_EMPTY;
...
{
    CS_DisableEntryIDMemoryCmd_t       CmdPacket;
    int32                              strCmpResult;
    char                               ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    CS_Def_EepromMemory_Table_Entry_t *DefMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].DefAddr;
    CS_Res_EepromMemory_Table_Entry_t *ResMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].ResAddr;
    ...
    ResMemoryTblPtr[CmdPacket.Payload.EntryID].State = CS_ChecksumState_ENABLED;
    DefMemoryTblPtr[CmdPacket.Payload.EntryID].State = CS_ChecksumState_ENABLED;
    ...
    /* Verify results */
    UtAssert_True(ResMemoryTblPtr[CmdPacket.Payload.EntryID].State == CS_ChecksumState_DISABLED,
                  "ResMemoryTblPtr[CmdPacket.Payload.EntryID].State == CS_ChecksumState_DISABLED");
    UtAssert_True(ResMemoryTblPtr[CmdPacket.Payload.EntryID].TempChecksumValue == 0,
                  "ResMemoryTblPtr[CmdPacket.Payload.EntryID].TempChecksumValue == 0");
    UtAssert_True(ResMemoryTblPtr[CmdPacket.Payload.EntryID].ByteOffset == 0,
                  "ResMemoryTblPtr[CmdPacket.Payload.EntryID].ByteOffset == 0");
    ...
    CS_Test_Check_SetDefEntryState(&DefMemoryTblPtr[CmdPacket.Payload.EntryID], CS_ChecksumState_DISABLED);
...
{
    CS_GetEntryIDMemoryCmd_t           CmdPacket;
    int32                              strCmpResult;
    char                               ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    CS_Res_EepromMemory_Table_Entry_t *ResMemoryTblPtr = CS_AppData.Tbl[CS_ChecksumType_MEMORY_TABLE].ResAddr;
    ...
    ResMemoryTblPtr[EntryID].StartAddress       = 1;
    CmdPacket.Payload.Address                   = 1;
    ResMemoryTblPtr[EntryID].NumBytesToChecksum = 10;
    ResMemoryTblPtr[EntryID].State              = CS_ChecksumState_ENABLED;
...
void CS_GetEntryIDMemoryCmd_Test_AddressNotFound(void)
{
    ...
    ResMemoryTblPtr[0].StartAddress       = 1;
    ResMemoryTblPtr[0].NumBytesToChecksum = 10;
...
void CS_GetEntryIDMemoryCmd_Test_AddressPtr(void)
{
    ...
    ResMemoryTblPtr[EntryID].StartAddress       = 12;
    CmdPacket.Payload.Address                   = 1;
    ResMemoryTblPtr[EntryID].NumBytesToChecksum = 10;
    ResMemoryTblPtr[EntryID].State              = CS_ChecksumState_ENABLED;
...
void CS_GetEntryIDMemoryCmd_Test_State(void)
{
    ...
    CmdPacket.Payload.Address                   = 1;
    ResMemoryTblPtr[EntryID].NumBytesToChecksum = 10;
    ResMemoryTblPtr[EntryID].State              = CS_ChecksumState_EMPTY;
...
void UtTest_Setup(void)
{
    ...
    UtTest_Add(CS_ReportBaselineEntryIDMemoryCmd_Test_Computed,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineEntryIDMemoryCmd_Test_Computed");
    UtTest_Add(CS_ReportBaselineEntryIDMemoryCmd_Test_NotYetComputed,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineEntryIDMemoryCmd_Test_NotYetComputed");
    UtTest_Add(CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh");
    UtTest_Add(CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty,
               CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_CreateChildTaskError,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineMemoryCmd_Test_CreateChildTaskError");
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh");
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorStateEmpty,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorStateEmpty");
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_RecomputeInProgress,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineMemoryCmd_Test_RecomputeInProgress");
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_OneShot,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineMemoryCmd_Test_OneShot");

    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_Nominal,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_EnableEntryIDMemoryCmd_Test_Nominal");
    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_EnableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty");
    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh");
    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty");
    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_OneShot,
               CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(CS_DisableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_DisableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty");
    UtTest_Add(CS_DisableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh,
               CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(CS_DisableEntryIDMemoryCmd_Test_OneShot,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_DisableEntryIDMemoryCmd_Test_OneShot");

    UtTest_Add(CS_GetEntryIDMemoryCmd_Test_Nominal,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_GetEntryIDMemoryCmd_Test_Nominal");
    UtTest_Add(CS_GetEntryIDMemoryCmd_Test_AddressNotFound,
               CS_Test_Setup,
               CS_Test_TearDown,
               "CS_GetEntryIDMemoryCmd_Test_AddressNotFound");
    UtTest_Add(CS_GetEntryIDMemoryCmd_Test_AddressPtr,
               CS_Test_Setup,
               CS_Test_TearDown,
